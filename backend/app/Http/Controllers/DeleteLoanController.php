...
use App\Core\Domain\Library\Ports\UseCases\DeleteLoan\{DeleteLoanRequestModel, DeleteLoanUseCase};
use App\Http\Requests\DeleteLoanRequest;
use Illuminate\Http\JsonResponse;
use Symfony\Component\HttpFoundation\Response;

class DeleteLoanController extends Controller
{
    public function __construct(private DeleteLoanUseCase $useCase)
    {
    }
     ...
     * @return JsonResponse
     */
    public function __invoke(DeleteLoanRequest $request)
    {
        $viewModel = $this->useCase->execute(new DeleteLoanRequestModel($request->validated()));
